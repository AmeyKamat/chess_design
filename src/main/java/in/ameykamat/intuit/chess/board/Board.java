...
import in.ameykamat.intuit.chess.piece.*;
...
public class Board {
    ...
    private Board(final int rows, final int columns) {
        ...
        for(int i=0; i<rows; i++){
            ...
            for(int j=0; j<columns; j++){
                final Color color = (i+j)%2 == 0 ? WHITE: BLACK;
    ...
    public void reset() throws IllegalCellException {
        ...
        addPiece(Position.of('a', 1), new Rook(WHITE));
        addPiece(Position.of('b', 1), new Knight(WHITE));
        addPiece(Position.of('c', 1), new Bishop(WHITE));
        addPiece(Position.of('d', 1), new Queen(WHITE));
        addPiece(Position.of('e', 1), new King(WHITE));
        addPiece(Position.of('f', 1), new Bishop(WHITE));
        addPiece(Position.of('g', 1), new Knight(WHITE));
        addPiece(Position.of('h', 1),new Rook(WHITE));

        addPiece(Position.of('a', 2), new Pawn(WHITE));
        addPiece(Position.of('b', 2), new Pawn(WHITE));
        addPiece(Position.of('c', 2), new Pawn(WHITE));
        addPiece(Position.of('d', 2), new Pawn(WHITE));
        addPiece(Position.of('e', 2), new Pawn(WHITE));
        addPiece(Position.of('f', 2), new Pawn(WHITE));
        addPiece(Position.of('g', 2), new Pawn(WHITE));
        addPiece(Position.of('h', 2), new Pawn(WHITE));

        addPiece(Position.of('a', 8), new Rook(BLACK));
        addPiece(Position.of('b', 8), new Knight(BLACK));
        addPiece(Position.of('c', 8), new Bishop(BLACK));
        addPiece(Position.of('d', 8), new Queen(BLACK));
        addPiece(Position.of('e', 8), new King(BLACK));
        addPiece(Position.of('f', 8), new Bishop(BLACK));
        addPiece(Position.of('g', 8), new Knight(BLACK));
        addPiece(Position.of('h', 8), new Rook(BLACK));

        addPiece(Position.of('a', 7), new Pawn(BLACK));
        addPiece(Position.of('b', 7), new Pawn(BLACK));
        addPiece(Position.of('c', 7), new Pawn(BLACK));
        addPiece(Position.of('d', 7), new Pawn(BLACK));
        addPiece(Position.of('e', 7), new Pawn(BLACK));
        addPiece(Position.of('f', 7), new Pawn(BLACK));
        addPiece(Position.of('g', 7), new Pawn(BLACK));
        addPiece(Position.of('h', 7), new Pawn(BLACK));
    }
    ...
    public boolean isCheckMate(final Color color) throws IllegalCellException {
        final List<Piece> attackers = (color == WHITE) ? blackPieces : whitePieces;
        final List<Piece> defenders = (color == WHITE) ? whitePieces : blackPieces;
        final King defender = (color == WHITE) ? whiteKing : blackKing;
        final Color opponentColor = (color == WHITE) ? BLACK : WHITE;
    ...
    private boolean isPositionUnderAttack(final Color color,
        ...
        List<Piece> attackers = (color == WHITE) ? blackPieces : whitePieces;
    ...
    private void addPiece(final Position position, final Piece piece) throws IllegalCellException {
        ...
        if(piece.getColor() == WHITE) whitePieces.add(piece);
        else blackPieces.add(piece);

        if(piece instanceof King && piece.getColor() == WHITE) whiteKing = (King) piece;
        if(piece instanceof King && piece.getColor() == BLACK) blackKing = (King) piece;
